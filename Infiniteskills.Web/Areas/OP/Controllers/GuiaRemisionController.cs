...
{
    public class GuiaRemisionController : AppController
    {
        ...
        public ActionResult ListarBandeja(string codigo, string fechaPedido, string razonSocial, string docComercialId)
        {
            ...
            try
            {
                ...
                IEnumerable<OrdenDTO> pedidoDTOList = _pedidoService.ListarGuiaRemision(parameters);
                int index = 1;
                var jsonData = new
                {
                    total = 1,
        ...
        public ActionResult Factura()
        {
            ...
            ordenItemDTOList = _pedidoItemService.ListarFactura(1005);

         //   var pdfRpt = new PdfActionResult(ordenItemDTOList);
