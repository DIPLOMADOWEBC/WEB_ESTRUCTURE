...
namespace Infiniteskills.Web.Areas.AM.Controllers
{
    ...
    public class ProveedorController : Controller
    {
        ...
        [HttpPost]
        public ActionResult ListarBandeja(string numeroDocumento, string razonSocial, string nombre)
        {
            ...
            try
            {
                ...
                //parameters.Add("tipoProveedor", TipoProveedorConstant.PROVEEDOR);
        ...
        public ActionResult Create(JsonHeader collection)
        {
            ...
            try
            {
                ...
                proveedorDTO.TipoCliente = TipoProveedorConstant.PROVEEDOR;
