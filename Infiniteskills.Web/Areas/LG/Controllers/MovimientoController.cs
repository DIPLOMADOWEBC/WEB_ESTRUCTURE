...
{
    public class MovimientoController : AppController
    {
        ...
        public MovimientoController(IOrdenService pedidoService, IOrdenItemService pedidoItemService,
            ...
            try
            {
                ...
                switch (editAction)
                {
                    ...
                    case EditActionConstant.EDIT:
                        ...
                        if (pedidoDTO.ProveedorDTO != null)
                        {
        ...
        public async Task<ActionResult> Create(JsonHeader collection)
        {
            ...
            try
            {
                ...
                {
                    case EditActionConstant.NEW:
                        await _pedidoService.InsertarMovimiento(pedidoDTO);
                        jsonResultMessage.message = "Movimiento grabado satisfactoriamente.";
                        break;
                    case EditActionConstant.EDIT:
                        _pedidoService.UpdateInventarioItem(pedidoDTO);
                        jsonResultMessage.message = "Movimiento actualizado satisfactoriamente.";
                        break;
                }
        ...
        private OrdenDTO CargarPedidoDTO(JsonHeader collection)
        {
            ...
            ordenDTO.Operacion = headerDictionary["TipoMovimientoId"];
            ...
            ordenDTO.OperacionFlag = headerDictionary["TipoMovimientoId"];
            ...
            if (!string.IsNullOrEmpty(headerDictionary["AlmacenDestinoId"]))
                ordenDTO.AlmacenDestinoId = Convert.ToInt32(headerDictionary["AlmacenDestinoId"]);
            else
                ordenDTO.AlmacenDestinoId = null;
